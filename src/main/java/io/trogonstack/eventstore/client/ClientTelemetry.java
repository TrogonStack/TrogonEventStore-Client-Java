...
class ClientTelemetry {
    ...
    static CompletableFuture<WriteResult> traceAppend(
            ...
            List<EventData> events, String streamId, TrogonEventStoreClientSettings settings,
        ...
        Span span = createSpan(
                ...
                ClientTelemetryTags.builder()
                        .withRequiredTag(ClientTelemetryAttributes.TrogonEventStore.STREAM, streamId)
    ...
    static void traceSubscribe(Runnable tracedOperation, String subscriptionId, ManagedChannel channel,
                               TrogonEventStoreClientSettings settings,
        ...
        Span span = createSpan(
                ...
                remoteParentContext,
                ClientTelemetryTags.builder()
                        .withRequiredTag(ClientTelemetryAttributes.TrogonEventStore.STREAM, event.getStreamId())
                        .withRequiredTag(ClientTelemetryAttributes.TrogonEventStore.SUBSCRIPTION_ID, subscriptionId)
                        .withRequiredTag(ClientTelemetryAttributes.TrogonEventStore.EVENT_ID, event.getEventId().toString())
                        .withRequiredTag(ClientTelemetryAttributes.TrogonEventStore.EVENT_TYPE, event.getEventType())
                        .withServerTagsFromGrpcChannel(channel)
                        .withServerTagsFromClientSettings(settings)
                        .withOptionalDatabaseUserTag(settings.getDefaultCredentials())
                        .withOptionalDatabaseUserTag(optionalCallCredentials)
