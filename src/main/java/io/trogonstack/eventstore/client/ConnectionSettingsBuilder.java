...
public class ConnectionSettingsBuilder {
    ...
    private static final Set<String> SUPPORTED_PROTOCOLS = new HashSet<>(Arrays.asList(
            "trogon-eventstore", "trogon-eventstore+discover"
    ));
     ...
     * @see TrogonEventStoreClientSettings
     * @return configured settings.
     */
    public TrogonEventStoreClientSettings buildConnectionSettings() {
        return new TrogonEventStoreClientSettings(_dnsDiscover,
    ...
    static TrogonEventStoreClientSettings parseFromUrl(ConnectionSettingsBuilder builder, URL url) {
