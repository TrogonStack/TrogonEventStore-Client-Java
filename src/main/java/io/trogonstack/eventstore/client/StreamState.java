 ...
 * <p>
 *
 * The TrogonEventStore server will assure idempotency for all requests using any value in <i>ExpectedRevision</i> except
 * <i>ANY</i>. When using <i>ANY</i>, TrogonEventStore will do its best to assure idempotency but will not
