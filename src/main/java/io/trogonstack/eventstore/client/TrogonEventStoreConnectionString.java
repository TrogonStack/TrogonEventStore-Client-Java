 ...
 */
public final class TrogonEventStoreConnectionString {
    TrogonEventStoreConnectionString() {}
     ...
     */
    public static TrogonEventStoreClientSettings parseOrThrow(String connectionString) {
        ConnectionSettingsBuilder builder = TrogonEventStoreClientSettings.builder();

        try {
            URL url = new URL(null, connectionString, new TrogonEventStoreUrlHandler());
            ...
            try {
                URL url = new URL(
                        ...
                        new TrogonEventStoreUrlHandler());
    ...
    /**
     * Supports TrogonEventStore connection string URL schemes.
     */
    public static class TrogonEventStoreUrlHandler extends URLStreamHandler {
        @Override
