...
/**
 * Represents a TrogonEventStore client for projection management. A client instance maintains two-way communication with TrogonEventStore.
 * Many threads can use the TrogonEventStore client simultaneously, or a single thread can make many asynchronous requests.
 */
public class TrogonEventStoreProjectionManagementClient {
    final TrogonEventStoreClientBase inner;
    private TrogonEventStoreProjectionManagementClient(TrogonEventStoreClientSettings settings) {
        inner = new TrogonEventStoreClientBase(settings);
    }

    private TrogonEventStoreProjectionManagementClient(TrogonEventStoreClientBase inner) {
        this.inner = inner;
    }
     ...
     */
    public static TrogonEventStoreProjectionManagementClient create(TrogonEventStoreClientSettings settings) {
        return new TrogonEventStoreProjectionManagementClient(settings);
    }
     ...
     */
    public static TrogonEventStoreProjectionManagementClient from(TrogonEventStoreClientBase existingClient) {
        return new TrogonEventStoreProjectionManagementClient(existingClient);
    }
