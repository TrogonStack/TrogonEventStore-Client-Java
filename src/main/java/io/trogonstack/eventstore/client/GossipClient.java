...
import io.trogonstack.eventstore.client.proto.gossip.GossipGrpc;
import io.trogonstack.eventstore.client.proto.gossip.GossipOuterClass;
...
class GossipClient {
    ...
    public GossipClient(TrogonEventStoreClientSettings settings, ManagedChannel channel) {
        _channel = channel;
