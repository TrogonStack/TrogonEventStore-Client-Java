...
public class ClientTelemetryAttributes {
    ...
    public static class TrogonEventStore {
        public static final String STREAM = "db.trogon_eventstore.stream";
        public static final String SUBSCRIPTION_ID = "db.trogon_eventstore.subscription.id";
        public static final String EVENT_ID = "db.trogon_eventstore.event.id";
        public static final String EVENT_TYPE = "db.trogon_eventstore.event.type";
    }
}
