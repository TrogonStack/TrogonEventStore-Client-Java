...
import io.trogonstack.eventstore.client.proto.streams.StreamsOuterClass;
...
final class GrpcUtils {
    ...
    static public <S extends AbstractAsyncStub<S>, O> S configureStub(S stub, TrogonEventStoreClientSettings settings, OptionsBase<O> options) {
        return configureStub(stub, settings, options, null, true);
    }

    static public <S extends AbstractAsyncStub<S>, O> S configureStub(S stub, TrogonEventStoreClientSettings settings, OptionsBase<O> options, long forceDeadlineInMs) {
        return configureStub(stub, settings, options, forceDeadlineInMs, true);
    }

    static public <S extends AbstractAsyncStub<S>, O> S configureStub(S stub, TrogonEventStoreClientSettings settings, OptionsBase<O> options, Long forceDeadlineInMs, boolean forwardRequiresLeader) {
        S finalStub = stub;
