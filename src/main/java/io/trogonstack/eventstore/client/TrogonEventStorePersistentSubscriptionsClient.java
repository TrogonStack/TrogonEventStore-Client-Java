...
/**
 * Represents a TrogonEventStore client for persistent subscription management. A client instance maintains two-way communication with TrogonEventStore.
...
public class TrogonEventStorePersistentSubscriptionsClient {
    private final TrogonEventStoreClientBase inner;

    private TrogonEventStorePersistentSubscriptionsClient(TrogonEventStoreClientSettings settings) {
        inner = new TrogonEventStoreClientBase(settings);
    }

    private TrogonEventStorePersistentSubscriptionsClient(TrogonEventStoreClientBase inner) {
        this.inner = inner;
    }
     ...
     */
    public static TrogonEventStorePersistentSubscriptionsClient create(TrogonEventStoreClientSettings settings) {
        return new TrogonEventStorePersistentSubscriptionsClient(settings);
    }
     ...
     */
    public static TrogonEventStorePersistentSubscriptionsClient from(TrogonEventStoreClientBase existingClient) {
        return new TrogonEventStorePersistentSubscriptionsClient(existingClient);
    }
    /**
