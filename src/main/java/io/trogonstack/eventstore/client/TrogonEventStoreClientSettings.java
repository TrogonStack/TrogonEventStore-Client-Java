 ...
 * <i>TrogonEventStoreClientSettings</i> can only be created when parsing a connection string.
 *
 * <i>TrogonEventStoreClientSettings</i> supports a wide range of settings. If a setting is not mentioned in the connection
