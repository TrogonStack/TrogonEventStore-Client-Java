...
import io.trogonstack.eventstore.client.proto.serverfeatures.ServerFeaturesGrpc;
import io.trogonstack.eventstore.client.proto.serverfeatures.Serverfeatures;
...
class ServerFeatures {
    public static Optional<ServerInfo> getSupportedFeatures(TrogonEventStoreClientSettings settings, ManagedChannel channel) {
