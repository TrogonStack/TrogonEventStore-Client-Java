...
class GrpcClient {
    ...
    private final TrogonEventStoreClientSettings settings;

    GrpcClient(TrogonEventStoreClientSettings settings, AtomicBoolean closed, LinkedBlockingQueue<Msg> queue) {
    ...
    public TrogonEventStoreClientSettings getSettings() {
