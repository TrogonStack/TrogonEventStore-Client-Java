...
import io.trogonstack.eventstore.client.resolution.DeferredNodeResolution;
import io.trogonstack.eventstore.client.resolution.DeprecatedNodeResolution;
import io.trogonstack.eventstore.client.resolution.FixedSeedsNodeResolution;
import io.trogonstack.eventstore.client.resolution.NodeResolution;
...
class ClusterDiscovery implements Discovery {
    ...
    ClusterDiscovery(TrogonEventStoreClientSettings settings) {
