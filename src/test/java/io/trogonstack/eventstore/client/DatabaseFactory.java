...
import io.trogonstack.eventstore.client.databases.DockerContainerDatabase;
import io.trogonstack.eventstore.client.databases.ExternallyCreatedCluster;
...
public class DatabaseFactory {
    ...
    private static DockerContainerDatabase.Builder singleNodeBuilder() {
        return DockerContainerDatabase
                .builder()
                .image(Optional
                        .ofNullable(System.getenv("TROGON_EVENTSTORE_IMAGE"))
