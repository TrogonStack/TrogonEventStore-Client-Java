package io.trogonstack.eventstore.client.telemetry;

import io.trogonstack.eventstore.client.ClientTelemetryAttributes;
import io.trogonstack.eventstore.client.ClientTelemetryConstants;
...
public interface TelemetryAware extends ConnectionAware {
    ...
    default void assertAppendSpanHasExpectedAttributes(ReadableSpan span, String streamName) {
        ...
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.TrogonEventStore.STREAM, streamName);
    ...
    default void assertSubscriptionActivityHasExpectedAttributes(ReadableSpan span, String streamName, String subscriptionId, String eventId, String eventType) {
        ...
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.Database.USER, "admin");
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.TrogonEventStore.STREAM, streamName);
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.TrogonEventStore.SUBSCRIPTION_ID, subscriptionId);
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.TrogonEventStore.EVENT_ID, eventId);
        assertSpanAttributeEquals(span, ClientTelemetryAttributes.TrogonEventStore.EVENT_TYPE, eventType);
        Assertions.assertEquals(StatusCode.OK, span.toSpanData().getStatus().getStatusCode());
