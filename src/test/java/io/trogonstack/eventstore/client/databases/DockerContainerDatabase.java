package io.trogonstack.eventstore.client.databases;
...
public class DockerContainerDatabase extends GenericContainer<DockerContainerDatabase> implements Database {
    public static final String DEFAULT_IMAGE = "ghcr.io/trogonstack/trogoneventstore:ci";
    ...
    public DockerContainerDatabase(Builder builder) {
        ...
        withEnv("EVENTSTORE_COMPRESSION_LEVEL", "NoCompression");
        if (builder.secure) {
    ...
    public ConnectionSettingsBuilder defaultSettingsBuilder() {
        ConnectionSettingsBuilder settingsBuilder = TrogonEventStoreClientSettings.builder().addHost(getHost(), getMappedPort(2113));
