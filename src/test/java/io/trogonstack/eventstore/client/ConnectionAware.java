...
public interface ConnectionAware {
    ...
    default TrogonEventStoreClient getDefaultClient() {
        return getDatabase().defaultClient();
    }

    default TrogonEventStoreProjectionManagementClient getDefaultProjectionClient() {
        return TrogonEventStoreProjectionManagementClient.from(getDefaultClient());
    }

    default TrogonEventStorePersistentSubscriptionsClient getDefaultPersistentSubscriptionClient() {
        return TrogonEventStorePersistentSubscriptionsClient.from(getDefaultClient());
    }
