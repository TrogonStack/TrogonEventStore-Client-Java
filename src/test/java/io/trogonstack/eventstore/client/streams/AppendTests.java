...
public interface AppendTests extends ConnectionAware {
    ...
    default void appendEvent(TrogonEventStoreClient client, String streamName, StreamState state) throws Exception {
        client.appendToStream(streamName, AppendToStreamOptions.get().streamState(state), createTestEvent()).get();
    }

    default void assertWrongExpectedVersion(TrogonEventStoreClient client, String streamName, StreamState state, StreamState expectedState, StreamState actualState) {
