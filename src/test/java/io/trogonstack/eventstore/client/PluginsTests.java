...
import io.trogonstack.eventstore.client.plugins.ClientCertificateAuthenticationTests;
...
/**
 * PluginsTests require the enterprise edition of TrogonEventStore (>= 24.2.0).
 */
