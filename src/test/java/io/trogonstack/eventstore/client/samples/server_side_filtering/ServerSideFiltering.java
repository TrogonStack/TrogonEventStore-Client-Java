package io.trogonstack.eventstore.client.samples.server_side_filtering;
...
public class ServerSideFiltering {
    private static void excludeSystemEvents(TrogonEventStoreClient client) {
    ...
    private static void eventTypePrefix(TrogonEventStoreClient client) {
    ...
    private static void eventTypeRegex(TrogonEventStoreClient client) {
    ...
    private static void streamPrefix(TrogonEventStoreClient client) {
    ...
    private static void streamRegex(TrogonEventStoreClient client) {
        //region stream-regex
        SubscriptionFilter filter = SubscriptionFilter.newBuilder()
    ...
    private static void checkpointCallback(TrogonEventStoreClient client) {
        //region checkpoint
        String excludeSystemEventsRegex = "/^[^\\$].*/";
    ...
    private static void CheckpointCallbackWithInterval(TrogonEventStoreClient client) {
