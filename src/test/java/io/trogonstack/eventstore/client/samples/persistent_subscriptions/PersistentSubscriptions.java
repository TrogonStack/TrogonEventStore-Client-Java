package io.trogonstack.eventstore.client.samples.persistent_subscriptions;
...
public class PersistentSubscriptions {
    public static void createPersistentSubscription(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void connectToPersistentSubscriptionToStream(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void connectToPersistentSubscriptionToStreamWithManualAcks(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void createPersistentSubscriptionToAll(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void connectToPersistentSubscriptionToAll(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void updatePersistentSubscription(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void deletePersistentSubscription(TrogonEventStorePersistentSubscriptionsClient client) {
    ...
    public static void getPersistentSubscriptionToStreamInfo(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void getPersistentSubscriptionToAllInfo(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void replayParkedToStream(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void replayParkedToAll(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void listPersistentSubscriptionToStream(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void listPersistentSubscriptionToAll(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
    ...
    public static void restartPersistentSubscriptionSubsystem(TrogonEventStorePersistentSubscriptionsClient client) throws ExecutionException, InterruptedException {
