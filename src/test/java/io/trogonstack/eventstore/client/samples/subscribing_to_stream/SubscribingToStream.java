package io.trogonstack.eventstore.client.samples.subscribing_to_stream;
...
public class SubscribingToStream {
    private static void subscribeToStream(TrogonEventStoreClient client) {
    ...
    private static void subscribeToAll(TrogonEventStoreClient client) {
    ...
    private static void subscribeToFiltered(TrogonEventStoreClient client) {
        SubscriptionListener listener = new SubscriptionListener() {
            @Override
            public void onEvent(Subscription subscription, ResolvedEvent event) {
                System.out.println("Received event"
    ...
    private static void overridingUserCredentials(TrogonEventStoreClient client) {
        SubscriptionListener listener = new SubscriptionListener() {
            @Override
            public void onEvent(Subscription subscription, ResolvedEvent event) {
                System.out.println("Received event"
