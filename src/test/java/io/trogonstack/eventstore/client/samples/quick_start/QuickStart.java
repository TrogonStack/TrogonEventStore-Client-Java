package io.trogonstack.eventstore.client.samples.quick_start;
...
public class QuickStart {
    public static void Run() throws ConnectionStringParsingException, ExecutionException, InterruptedException, JsonProcessingException {
        // region createClient
        TrogonEventStoreClientSettings settings = TrogonEventStoreConnectionString.parseOrThrow("{connectionString}");
