package io.trogonstack.eventstore.client.samples.projection_management;
...
public class ProjectionManagement {
    ...
    public void testProjectionManagementSamples() throws Throwable {
        ...
        try {
            TrogonEventStoreProjectionManagementClient client = TrogonEventStoreProjectionManagementClient.from(database.defaultClient());
            disable(client);
    ...
    private static TrogonEventStoreProjectionManagementClient createClient(String connection) {
        // region createClient
        TrogonEventStoreClientSettings settings = TrogonEventStoreConnectionString.parseOrThrow(connection);
    ...
    private static void disable(TrogonEventStoreProjectionManagementClient client)
    ...
    private static void disableNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void enable(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region Enable
    ...
    private static void enableNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void delete(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void deleteNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void abort(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region Abort
    ...
    private static void abortNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void reset(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region Reset
    ...
    private static void resetNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void create(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void createConflict(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        String js = "{}";
    ...
    private static void update(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region Update
    ...
    private static void updateNotFound(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void listAll(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region ListAll
    ...
    private static void list(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
    ...
    private static void getStatus(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region GetStatus
    ...
    private static void getState(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region GetState
    ...
    private static void getResult(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
        // region GetResult
    ...
    private static void restartSubSystem(TrogonEventStoreProjectionManagementClient client)
            throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
