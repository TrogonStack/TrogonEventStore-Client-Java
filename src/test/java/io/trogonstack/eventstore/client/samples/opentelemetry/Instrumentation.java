package io.trogonstack.eventstore.client.samples.opentelemetry;
...
public class Instrumentation {
    private static void tracing(TrogonEventStoreClient client) throws ExecutionException, InterruptedException, JsonProcessingException {
